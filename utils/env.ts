...
function getAnyEnv(): AnyEnv {
  ...
  const procEnv =
    typeof process !== "undefined" ? (process.env as AnyEnv) : undefined;
  ...
  if (typeof window !== "undefined") {
    ...
    if (typeof window !== "undefined") {
      ...
      if (windowAny.VITE_GOOGLE_MAPS_API_KEY)
        figmaSecrets.VITE_GOOGLE_MAPS_API_KEY =
          windowAny.VITE_GOOGLE_MAPS_API_KEY;
      if (windowAny.VITE_OPENAI_API_KEY)
        figmaSecrets.VITE_OPENAI_API_KEY = windowAny.VITE_OPENAI_API_KEY;
      if (windowAny.VITE_STREAM_CHAT_API_KEY)
        figmaSecrets.VITE_STREAM_CHAT_API_KEY =
          windowAny.VITE_STREAM_CHAT_API_KEY;
    }
  }
  ...
  if (info.runtime.isFigmaMake) {
    ...
    console.log(
      ...
      typeof window !== "undefined"
        ? Object.keys((window as any).env || {})
        : "none"
    );
    console.log(
      "- Global environment variables:",
      typeof globalThis !== "undefined"
        ? Object.keys((globalThis as any).env || {})
        : "none"
    );
    console.log(
      "- Direct window API keys:",
      typeof window !== "undefined"
        ? {

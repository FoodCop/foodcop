...
// Test SaveToPlate functionality with service role
async function testSaveToPlateService() {
  console.log("🧪 Testing SaveToPlate functionality (service role)...");
  ...
  try {
    ...
    const testItem = {
      ...
      item_id: "test-restaurant-service-789",
      metadata: {
        title: "Test Restaurant Service",
...
// Run the test
testSaveToPlateService().catch(console.error);

...
export const config = {
  ...
  app: {
    ...
    newUiUrl: import.meta.env.VITE_NEW_UI_URL || (import.meta.env.DEV ? 'http://localhost:3000/' : ''),
    newUiEnabled: Boolean(import.meta.env.VITE_NEW_UI_URL) || import.meta.env.DEV,
    // Feature Flags
    features: {

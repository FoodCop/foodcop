...
import { Place, Restaurant, OpenInNew, DirectionsWalk } from '@mui/icons-material';
    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      ...
      {restaurant.imageUrl ? (
        ...
        <div className="w-full h-48 bg-gray-100 flex items-center justify-center">
          <Restaurant className="w-12 h-12 text-gray-400" />
        </div>
      )}
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-start gap-2">
          <Place className="w-4 h-4 text-gray-500 mt-0.5 flex-shrink-0" />
          <div className="flex-1 min-w-0">
            ...
            {restaurant.distance && (
              <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                <DirectionsWalk style={{ fontSize: '10pt' }} aria-label="Distance" />
                {restaurant.distance}
              </p>
            )}
          </div>
        ...
        {restaurant.cuisine && (
          <div className="flex items-center gap-2">
            <Restaurant className="w-4 h-4 text-gray-500" />

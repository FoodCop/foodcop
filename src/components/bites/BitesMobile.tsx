            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <h3 className="text-base font-bold text-neutral-900 flex-1 text-left">{recipe.title}</h3>
                  <div className="flex items-center gap-1 ml-2">
                    <Star className="w-4 h-4 text-accent-yellow-500 fill-accent-yellow-500" />
                    <span className="text-sm font-semibold text-neutral-900">{((recipe.healthScore || 50) / 20).toFixed(1)}</span>
                  </div>
                </div>
                ...
                {recipe.diets.length > 0 && (
                  <div className="flex items-center gap-2 mb-3">
                    {recipe.diets.slice(0, 2).map((diet) => (
                      <span key={diet} className="px-2.5 py-1 rounded-full bg-surface-secondary text-xs font-medium text-neutral-900">
                        {diet}
                      </span>
                    ))}
                  </div>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-neutral-200">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-surface-secondary text-neutral-900 text-sm font-medium flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-accent-yellow-500 text-neutral-900 text-sm font-medium flex items-center justify-center gap-2"
                  >
      ...
      <header className="px-4 pt-6 pb-4 bg-surface-secondary sticky top-0 z-50">
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-2 top-2 w-8 h-8 rounded-xl bg-accent-yellow-500 flex items-center justify-center"
          >
            ...
            <div className="flex gap-3 overflow-x-auto pb-2">
              {trendingRecipes.map((recipe) => (
                ...
                >
                  ...
                  <div className="p-3">
                    <h3 className="text-sm font-bold text-neutral-900 mb-1 text-left line-clamp-2">{recipe.title}</h3>
                    <div className="flex items-center gap-1 mb-2">
                      <Star className="w-3 h-3 text-accent-yellow-500 fill-accent-yellow-500" />
                      <span className="text-xs font-semibold text-neutral-900">{((recipe.healthScore || 50) / 20).toFixed(1)}</span>

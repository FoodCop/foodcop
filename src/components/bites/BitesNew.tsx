      ...
      <main className="flex-1 pb-6">
        ...
        <section className="px-5 pt-5 pb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-12 pl-12 pr-14 rounded-2xl bg-[#F3F4F6] text-sm text-[#1A1A1A] placeholder:text-[#ADAEBC] border-0 focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20"
            />
        ...
        <section className="mb-6">
          <div className="px-5 mb-3">
            <h2 className="text-[#1A1A1A] font-bold text-base leading-6 font-[Poppins]">Browse by Diet</h2>
          </div>
          <div className="flex gap-3 overflow-x-auto pl-5 pb-2 hide-scrollbar">
        ...
        <section className="px-5 pb-6">
          <button
            ...
            disabled={loading}
            className="w-full h-12 rounded-2xl bg-white border-2 border-[#FF6B35] text-[#FF6B35] font-bold text-sm font-[Poppins] flex items-center justify-center gap-2 hover:bg-[#FF6B35] hover:text-white transition-all disabled:opacity-50"
          >
        ...
        {/* Loading State */}
        {loading && (
          <div className="px-5 flex flex-col items-center justify-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FF6B35] mb-4"></div>
            <p className="text-[#6B7280] text-sm font-[Inter]">Loading delicious recipes...</p>
          </div>
        )}
        ...
        {error && !loading && (
          <div className="px-5 flex flex-col items-center justify-center py-12">
            ...
            <p className="text-red-600 font-bold text-base mb-1 font-[Poppins]">Failed to load recipes</p>
            <p className="text-[#6B7280] text-sm mb-4 font-[Inter]">{error}</p>
            <button
              onClick={() => loadRecipes("popular recipes")}
              className="px-6 py-2 rounded-xl bg-[#FF6B35] text-white font-semibold text-sm font-[Inter]"
            >
              Try Again
            </button>
          </div>
        ...
        {!loading && !error && recommendedRecipes.length > 0 && (
          <section className="mb-6">
            <div className="px-5 flex items-center justify-between mb-3">
              <h2 className="text-[#1A1A1A] font-bold text-base leading-6 font-[Poppins]">Recommended for You</h2>
                ...
                >
                  <div className="relative h-32">
                    ...
                    {recipe.healthScore && recipe.healthScore > 70 && (
                      <div className="absolute top-2 left-2 flex items-center gap-1 px-2 py-1 rounded-full bg-green-500 text-white">
                  ...
                  <div className="p-3">
                    <h3 className="text-[#1A1A1A] font-bold text-sm leading-5 mb-2 font-[Poppins] line-clamp-2">
                      {recipe.title}
                    </h3>
                    <div className="flex items-center justify-between text-[#6B7280] text-xs font-[Inter]">
        ...
        {!loading && !error && mightLikeRecipes.length > 0 && (
          <section className="mb-6">
            <div className="px-5 flex items-center justify-between mb-3">
              <h2 className="text-[#1A1A1A] font-bold text-base leading-6 font-[Poppins]">You Might Also Like</h2>
              <button className="text-[#FF6B35] text-sm font-semibold font-[Inter]">See All</button>
            </div>
            <div className="px-5 grid grid-cols-2 gap-4">

      ...
      <div className="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
          ...
          <div className="modal-body p-4">
            <div className="d-flex justify-content-between align-items-start mb-3">
              <div>
                ...
                <span className="badge bg-primary fz-on-accent text-uppercase">{category}</span>
              </div>
            </div>
              ...
              <div className="mb-4">
                <ul className="nav nav-pills nav-fill mb-3 bg-light rounded-3 p-1">
                  <li className="nav-item">
                    <button
                      className={`nav-link rounded-3 fw-bold ${activeTab === 'details' ? 'active bg-primary fz-on-accent' : 'text-secondary'}`}
                  ...
                  <li className="nav-item">
                    <button
                      className={`nav-link rounded-3 fw-bold ${activeTab === 'ingredients' ? 'active bg-primary fz-on-accent' : 'text-secondary'}`}
                  ...
                  <li className="nav-item">
                    <button
                      className={`nav-link rounded-3 fw-bold ${activeTab === 'instructions' ? 'active bg-primary fz-on-accent' : 'text-secondary'}`}
          ...
          <div className="modal-footer bg-light border-top-0 p-3 d-flex gap-2">
            ...
            <button type="button" className="btn btn-primary flex-grow-1 fw-bold fz-on-accent rounded-pill" onClick={handleShareClick}>
              Share
            </button>
          </div>
        </div>

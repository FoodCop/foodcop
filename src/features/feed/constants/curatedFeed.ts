...
export const LOCAL_CURATED_FEED_ITEMS: FeedUiItem[] = [
  { id: 'recipe-r1', itemType: 'recipe', itemId: 'r1', name: 'Crispy Miso Salmon', cat: 'Recipe', img: 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=800&q=80', metadata: {} },
  { id: 'video-v1', itemType: 'video', itemId: 'v1', name: '30-Minute Sushi Roll', cat: 'Studio Trim', img: 'https://images.unsplash.com/photo-1553621042-f6e147245754?auto=format&fit=crop&w=800&q=80', metadata: {} },
  ...
  { id: 'recipe-r2', itemType: 'recipe', itemId: 'r2', name: 'Pesto Burrata Pasta', cat: 'Recipe', img: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&w=800&q=80', metadata: {} },
  { id: 'video-v2', itemType: 'video', itemId: 'v2', name: 'Street Taco Masterclass', cat: 'Studio Trim', img: 'https://images.unsplash.com/photo-1613514785940-daed07799d9b?auto=format&fit=crop&w=800&q=80', metadata: {} },

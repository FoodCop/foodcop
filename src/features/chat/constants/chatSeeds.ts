import type { ChatFriend } from '../types/chatUi';

export const DEFAULT_FRIENDS: ChatFriend[] = [
...
export const INITIAL_MESSAGES_BY_FRIEND: Record<number, Array<{ role: 'ai'; text: string }>> = {

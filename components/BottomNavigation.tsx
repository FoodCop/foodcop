...
import { Home, Map, Camera, ChefHat } from 'lucide-react';
      ...
      <div className="flex justify-around items-end max-w-md mx-auto">
        {tabs.map((tab) => {
          ...
          if (isCenter) {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-medium mt-0.5 text-[#F14C35]">{tab.label}</span>
              </button>
            );
          }
          ...
          return (
            ...
            >
              <div className={`p-2 rounded-xl relative ${isActive ? 'bg-[#F14C35]' : ''}`}>
                <IconComponent 

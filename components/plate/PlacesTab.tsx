      ...
      >
        ...
        >
          ...
          <p className="text-gray-600">
            Tako is fetching your saved places! 🍽️
          </p>
        </motion.div>
      </div>
    );
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 mb-6 max-w-sm">
            Start exploring and save your favorite restaurants to your plate!
    ...
    <div className={`flex-1 bg-gray-50 ${className}`}>
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-4 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <MapPin className="w-5 h-5 text-[#F14C35]" />
              <span className="font-bold text-[#0B1F3A]">
                {filteredRestaurants.length + filteredRecipes.length} saved
                place
      ...
      {showStats && (
        <div className="bg-[#F8F9FA] rounded-xl p-4 border border-gray-200 m-4">
          <h3 className="font-medium text-[#0B1F3A] mb-3">Places Stats</h3>

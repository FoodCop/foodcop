...
export function FuzoAIAssistant({
  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      ...
      type: "ai",
      content:
        "Hi there! I'm Tako, your intelligent FUZO food assistant! 🐙 I'm powered by AI and ready to help you discover amazing restaurants, find delicious recipes, navigate the app, or answer any food-related questions. What culinary adventure can I help you with today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
      ...
      console.error(
        "🐙 Tako AI: Error occurred, falling back to mock response:",
        error
      );
      setIsTyping(false);
  ...
  const generateFallbackResponse = (userInput: string): AIMessage => {
    ...
    if (
      ...
      return {
        ...
        type: "ai",
        content:
          "I found some great restaurants near you! Check out these top picks:",
        timestamp: new Date(),
        cards: [
          {
            id: "rest_1",
        ...
        cards: [
          {
            ...
            data: {
              ...
              image:
                "https://images.unsplash.com/photo-1693820206848-6ad84857832a?w=400",
              cookingTime: 25,
              difficulty: "Easy",
            },
          },
    ...
    if (
      ...
      return {
        ...
        type: "ai",
        content:
          "FUZO is your social food discovery platform! Here's how it works:",
        timestamp: new Date(),
        cards: [
          {
            id: "help_1",
            ...
            data: {
              title: "Discover Food",
              description:
                "Swipe through nearby restaurants and save your favorites to your Plate",
              icon: "heart",
            },
          },
          {
            ...
            data: {
              title: "Find Recipes",
              description:
                "Browse and create amazing recipes in our Bites section",
              icon: "chef",
            },
          },
          {
            ...
            data: {
              ...
              description:
                "Use our map to find restaurants by location and cuisine",
              icon: "map",
            },
          },
        ],
    ...
    if (
      ...
      return {
        ...
        type: "ai",
        content:
          "I can help you navigate to any restaurant! Would you like me to show you directions?",
        timestamp: new Date(),
        cards: [
          {
            id: "map_1",
    ...
    return {
      id: Date.now().toString() + "_ai",
      content:
        "🐙 I'm currently using my backup responses while my AI brain reconnects. For full AI assistance, please try the 'Test AI Connection' button to help diagnose any issues. In the meantime, I can still help with basic questions!",
      timestamp: new Date(),
      type: "ai",
    };
  };
...
function MessageCard({
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        <div className="flex">
          ...
          <div className="flex-1 p-3">
            <h4 className="font-semibold text-sm text-[#0B1F3A] mb-1">
              {name}
            </h4>
  ...
  if (card.type === "help") {
    ...
    const IconComponent =
      icon === "heart" ? Heart : icon === "chef" ? ChefHat : MapPin;

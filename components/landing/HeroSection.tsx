    ...
    >
      ...
      <div className="relative text-center text-white z-10 max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10 text-sm">
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Street Food</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Fine Dining</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Sushi</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Pastry</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Healthy</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">BBQ</span>
          <span className="bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">Vegan</span>
        </div>

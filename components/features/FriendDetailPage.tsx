...
import { mockFriendProfiles } from "./constants/profileData";
...
export function FriendDetailPage({
  ...
  const tabs = [
    {
      id: "plate" as FriendTab,
      label: "Plate",
      count: friend.savedPlaces.length,
    },
    { id: "photos" as FriendTab, label: "Photos", count: friend.photos.length },
    {
      id: "reviews" as FriendTab,
      label: "Reviews",
      count: friend.reviews.length,
    },
    {
      id: "rewards" as FriendTab,
      label: "Rewards",
      count: friend.badges.length,
    },
  ];
  ...
  const handleCopyProfile = () => {
    navigator.clipboard.writeText(
      `Check out ${friend.displayName}'s food profile on FUZO!`
    );
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "rewards":
        return (
          <FriendRewardsTab badges={friend.badges} points={friend.points} />
        );
      default:
        return <FriendPlateTab savedPlaces={friend.savedPlaces} />;
    }

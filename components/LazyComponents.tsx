...
export const LazyChatPage = lazy(() => import('./ChatPage').then(module => ({ default: module.ChatPage })))
export const LazyRecipesPage = lazy(() => import('./RecipesPage').then(module => ({ default: module.RecipesPage })))
export const LazyScoutPage = lazy(() => import('./ScoutPage').then(module => ({ default: module.ScoutPage })))
export const LazySnapPage = lazy(() => import('./SnapPage').then(module => ({ default: module.SnapPage })))
export const LazyProfilePage = lazy(() => import('./ProfilePage').then(module => ({ default: module.ProfilePage })))
export const LazyGroupDiningPage = lazy(() => import('./GroupDiningPage').then(module => ({ default: module.GroupDiningPage })))
export const LazyMasterBotsShowcase = lazy(() => import('./MasterBotsShowcase').then(module => ({ default: module.MasterBotsShowcase })))
export const LazyMasterBotDashboard = lazy(() => import('./MasterBotDashboard').then(module => ({ default: module.MasterBotDashboard })))
...
export const LazyWrapper = ({ children, fallback, componentName = 'component' }: LazyWrapperProps) => (
  <ErrorBoundary>
    <AsyncErrorBoundary>
      <Suspense fallback={fallback || <LazyFallback componentName={componentName} />}>
        {children}
      </Suspense>
    </AsyncErrorBoundary>
  </ErrorBoundary>

import { Clock, Filter, MapPin, Share2, Star, Trash2 } from "lucide-react";
    ...
    try {
      ...
      if (result.success) {
        setSavedRestaurants((prev) =>
          prev.filter((r) => r.place_id !== placeId)
        );
  ...
  const filters = [
    {
      ...
      label: "All",
      count: savedRestaurants.length + savedRecipes.length,
    },
    {
      ...
      {filteredPlaces.length === 0 && filteredRecipes.length === 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">
            Start exploring and save your favorite restaurants and recipes.
          </p>
        ...
        <div className="space-y-6">
          ...
          {filteredPlaces.length > 0 && (
            <div>
              {activeFilter === "all" && (
                <h3 className="font-medium text-[#0B1F3A] mb-3">
                  Restaurants ({filteredPlaces.length})
                </h3>
              )}
                      ...
                      <div className="flex-1 p-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              onClick={() =>
                                handleUnsaveRestaurant(place.place_id)
                              }

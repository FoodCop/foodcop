              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Your AI food assistant</p>
                  </div>
                </div>
                <button
                  onClick={handleDismiss}
            ...
            <div className="p-6">
              <div className="mb-4">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-bold text-[#0B1F3A]">I'm here to help!</h4>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
                  I can help you discover restaurants, find recipes, navigate the app, and answer any food-related questions you have!
                </p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-sm text-[#0B1F3A]">Ask anything</p>
                    <p className="text-xs text-gray-500">"Find me good sushi nearby"</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-sm text-[#0B1F3A]">Smart suggestions</p>

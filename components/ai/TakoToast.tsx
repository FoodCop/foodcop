        ...
        <div className="px-4 pb-4">
          <div className="bg-[#F14C35]/5 rounded-2xl p-4 mb-4 relative">
            <p className="text-[#0B1F3A] font-medium text-sm leading-relaxed">
              Great choice! <span className="font-bold">{restaurant.name}</span>{" "}
              looks delicious. Shall I plan a route or save this to your Plate
              for later?
            </p>
          ...
          <div className="flex items-center space-x-3 mt-4 p-3 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-[#0B1F3A] text-sm">
                {restaurant.name}
              </h4>

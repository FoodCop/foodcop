    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-blue-50 to-orange-100 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">FUZO</h1>
          ...
          <CardContent className="space-y-6">
            ...
            {error && (
              <div className="flex items-center gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                ...
                <span className="text-sm text-red-700">
                  ...
                  {error === 'auth_exception' && 'An error occurred during sign in. Please try again.'}
                  ...
                  {!['auth_error', 'auth_exception', 'no_session', 'no_code'].includes(error) && 'An unexpected error occurred. Please try again.'}
                </span>
              </div>
            )}
            ...
            <div className="pt-6 border-t border-gray-100">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mr-3"></div>
                  Save your favorite places and recipes
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mr-3"></div>
        ...
        <p className="text-xs text-gray-500 text-center mt-6 px-4">
          ...
          We&apos;ll help you discover amazing food experiences while keeping your data secure.
        </p>
      </div>
    </div>
  );
